...
export default function HomeScreen() {
  ...
  useEffect(() => {
    if (params.date && typeof params.date === 'string') {
      console.log('Navigated from search with date:', params.date);
  ...
  const renderGoalCard = (goal: ActivatedGoal) => {
    ...
    const todaySuccessCount = goal.dailyEntries?.filter(e => e.type === 'success').length || 0;
    const shouldShowStreakOnToday = streakBeforeToday > 0 || todaySuccessCount > 0;
  ...
  const renderConciseGoalCard = (goal: ActivatedGoal) => {
    ...
    const shouldShowStreakOnTodayConcise = streakBeforeToday > 0 || todaySuccessCountConcise > 0;
            ...
            >
              <View style={styles.journalCardHeader}>
                ...
                <TouchableOpacity 
                  onPress={(e) => {
                    e.stopPropagation();
                    console.log('Opening search journals screen');
