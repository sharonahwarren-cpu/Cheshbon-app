...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    console.log('[Profile iOS] Screen mounted, user:', user ? user.email : 'not logged in');
    loadStats();
  }, []);

  useEffect(() => {
    console.log('[Profile iOS] User state changed:', user ? user.email : 'not logged in');
  }, [user]);
  ...
  if (!user) {
    console.log('[Profile iOS] No user found, showing loading...');
    return (
