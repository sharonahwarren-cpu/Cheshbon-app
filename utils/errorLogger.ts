    ...
    try {
      fetch(url, {
        ...
        if (!fetchErrorLogged) {
          ...
          // Silently ignore fetch errors to avoid recursion and console pollution
          // The logs will still be visible in the app's console via the original console methods
        }
      });
    } catch (e) {
